    ...
    return (
        <header>
            ...
            <div className="contact">
                <a href="https://github.com/MatheusWeisheimer" target="blank"><ContactIcon path={githubIconPath} width="1.87rem" darkMode={true}/></a>
                <a href="https://www.linkedin.com/in/matheus-weisheimer-30325a242/" target="blank"><ContactIcon path={linkedinIconPath} width="1.87rem" darkMode={true}/></a>
            </div>
        </header>
    )
}
