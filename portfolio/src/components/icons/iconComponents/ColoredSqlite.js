function ColoredSqlite({width}) {
    return (
        <svg style={{width: width, height: width}} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 6.554 6.555" preserveAspectRatio="xMidYMid">
        <defs>
